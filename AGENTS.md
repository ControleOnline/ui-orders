...
- `OrderLogisticsPage` e compartilhada entre o overview do manager e o detalhe da delivery. O overview monta o bloco de lista abaixo do mapa; o detalhe da delivery nao monta esse bloco. A tela principal decide apenas por inclusao dos componentes `OrderLogisticsQuotesList` e `DeliveryAcceptanceCard`.
