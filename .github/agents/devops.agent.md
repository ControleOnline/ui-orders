---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-orders, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-orders`.
