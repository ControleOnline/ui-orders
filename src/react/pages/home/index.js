 ...
 * - Em pedidos integrados, o identificador principal das telas operacionais deve vir apenas do campo canonico do payload da integracao. `pickup_code` e `handover_code` continuam como dados logistico-operacionais e nao podem substituir o codigo principal do pedido; hashes e ids tecnicos continuam apenas no summary.
